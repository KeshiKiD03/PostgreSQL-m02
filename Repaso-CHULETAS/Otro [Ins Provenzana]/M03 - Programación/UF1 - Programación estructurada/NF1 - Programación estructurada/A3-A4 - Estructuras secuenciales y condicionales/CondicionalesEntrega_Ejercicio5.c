...
int main(){
    ...
    // Si la hora llega a las 23:59 = 11:59PM pasará a 00:00 = 12:00AM
    	if(seg==59 && min==59 && hora==23){
    		seg=0;
    		min=0;
    		hora=0;
    	}
    // Si los minutos y segundos llegan a 59 se añade +1 hora
    	else if(seg==59 && min==59){
    		seg=0;
    		min=0;
    		hora++;
    	}
	// Si los segundos llega a 59 entonces volverá al valor 0 y los minutos se sumará  	
    	else if(seg==59){
    		seg=0;
    		min++;
    	}
