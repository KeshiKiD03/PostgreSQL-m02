...
Tots els venedors amb el codi i el nom del seu director, tant si el venedor te director com si no en te.
select repV.num_empl as empleado,repV.director,repD.num_empl,repD.nombre as director
from repventas repV
  join repventas repD on repV.director=repD.num_empl;

select repV.num_empl as empleado,repV.director,repD.num_empl,repD.nombre as director
from repventas repV
  left join repventas repD on repV.director=repD.num_empl;

Tot els venedors i el codi de la seva oficina + la seva ciutat, els venedors que no tenen oficina ha de sortir igualment.
select num_empl,oficina_rep,ciudad
from repventas
